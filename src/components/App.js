...
const games = [
  {
    ...
    name: "Milele",
    thumbnail:
      "https://images.pexels.com/photos/45775/pexels-photo-45775.jpeg?auto=compress&cs=" +
  ...
  },
  {
    ...
    name: "Superman",
    thumbnail:
      "https://images.pexels.com/photos/205324/pexels-photo-205324.jpeg?auto=compress&c" +
  ...
  },
  {
    ...
    name: "Kila kitu",
    thumbnail:
      "https://images.pexels.com/photos/127513/pexels-photo-127513.jpeg?auto=compress&c" +
...
class App extends React.Component {
  ...
  render() {
    const numberOfColumns =
      this.state.showGameForm || this.state.showSignupForm || this.loginForm
        ? "ten"
        : "sixteen";
    return (
        ...
        <div className="ui stackable grid">
          <div className="six wide column">
            ...
            {this.state.showSignupForm && (
              <SignupForm hideSignupForm={this.hideSignupForm} />
            )}
            {this.state.showLoginForm && (
              <LoginForm hideLoginForm={this.hideLoginForm} />
            )}
          </div>
